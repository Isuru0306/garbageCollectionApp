...
import com.garbagecollections.databinding.ActivityAdminDrawerBinding;
...
public class AdminDrawerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_admin_home, R.id.nav_admin_vehicle,R.id.admin_data_report,  R.id.admin_notifications, R.id.nav_admin_users)
